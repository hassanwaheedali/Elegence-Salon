            ...
            <section className="bg-[#0F0F0F]">
                ...
                <div className="container mx-auto px-4 pb-12 md:pb-18">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 max-w-5xl mx-auto">
                        <a href="tel:+923001234567" className="group relative overflow-hidden bg-linear-to-br from-[#1a1a1a] to-[#0f0f0f] p-5 sm:p-6 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-500 border border-yellow-500/10 hover:border-yellow-500/40 focus:outline-none focus:ring-2 focus:ring-[#fb9d33] focus:ring-offset-2 focus:ring-offset-[#0F0F0F]">
                        ...
                        <a href="mailto:info@elegance.com" className="group relative overflow-hidden bg-linear-to-br from-[#1a1a1a] to-[#0f0f0f] p-5 sm:p-6 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-500 border border-yellow-500/10 hover:border-yellow-500/40 focus:outline-none focus:ring-2 focus:ring-[#fb9d33] focus:ring-offset-2 focus:ring-offset-[#0F0F0F]">
                            {/* Animated background glow */}
                            <div className="absolute inset-0 bg-radial-gradient via-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" style={{
                                backgroundImage: 'radial-gradient(circle at center, rgba(234, 179, 8, 0.05) 0%, transparent 70%)'
                            }}></div>
                        ...
                        <a href="https://wa.me/923001234567" target="_blank" className="group relative overflow-hidden bg-linear-to-br from-[#1a1a1a] to-[#0f0f0f] p-5 sm:p-6 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-500 border border-yellow-500/10 hover:border-yellow-500/40 focus:outline-none focus:ring-2 focus:ring-[#fb9d33] focus:ring-offset-2 focus:ring-offset-[#0F0F0F]">
                            {/* Animated background glow */}
                            <div className="absolute inset-0 bg-radial-gradient via-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" style={{
                                backgroundImage: 'radial-gradient(circle at center, rgba(234, 179, 8, 0.05) 0%, transparent 70%)'
                            }}></div>
                ...
                <div className="container max-w-7xl mx-auto pb-14 px-4 gap-10 md:gap-12 lg:gap-14 grid grid-cols-1 lg:grid-cols-2 pt-8">
                    ...
                    <div className="store-section mt-8 lg:mt-0 px-6 md:px-8 pb-12 md:pb-0">
                        <div className="visit-store-section">
                            ...
                            <div className="store-info bg-[#161515] -mx-6 sm:-mx-8 -mt-8 px-6 sm:px-8 py-8 mb-10 md:mb-8 rounded-b-lg shadow-lg transition-all duration-500">
                                <div className="space-y-6">
                                    <div className="space-y-6">
                                        <div className="flex gap-3">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-map-pin h-5 w-5 text-[#fb9d33] mt-1 shrink-0"><path d="M20 10c0 4.993-5.539 10.193-7.399 11.799a1 1 0 0 1-1.202 0C9.539 20.193 4 14.993 4 10a8 8 0 0 1 16 0"></path><circle cx="12" cy="10" r="3"></circle></svg>
                                            <div>
                                                <h3 class="font-semibold mb-1 text-white text-base sm:text-lg">Address</h3>
                                                <p class="text-[#777777] text-sm sm:text-base font-semibold leading-relaxed">123 Main Street, Gulberg III <br /> Lahore, Punjab 54000<br></br> Pakistan</p>
                                            </div>
                                        </div>
                                        <div className="flex gap-3">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-clock h-5 w-5 text-[#fb9d33] mt-1 shrink-0"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg>
                                            <div>
                                                <h3 class="font-semibold mb-1 text-white text-base sm:text-lg">Business Hours</h3>
                                                <div class="space-y-1 text-sm sm:text-base text-[#777777]">
