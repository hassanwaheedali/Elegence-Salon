...
const ServiceCard = ({ icon, title, description, price, onClick, image }) => {
    return (
        ...
        >
            ...
            {/* Decorative Top Line */}
            <div className="absolute left-0 top-0 h-1 w-full bg-linear-to-r from-transparent via-[#FF8A00] to-transparent opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
            ...
            <div className="relative z-10 flex h-full flex-col p-8 justify-between">
                ...
                <div className="flex">
                    <div className="relative flex h-16 w-16 items-center justify-center rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-[#FF8A00] transition-all duration-500 group-hover:scale-110 group-hover:bg-[#FF8A00] group-hover:text-white group-hover:border-[#FF8A00] shadow-lg">
                ...
                <div className="transform transition-all duration-500 translate-y-2 group-hover:translate-y-0">
                    ...
                    <div className="mb-4 h-0.5 w-12 bg-[#FF8A00] transition-all duration-500 group-hover:w-full" />
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-white/10">
                        <span className="text-2xl font-black text-[#FF8A00] tracking-wider drop-shadow-sm">
                            {price}
                        </span>
                        <a href="#appointment">
                            <button className="group/btn flex items-center gap-2 rounded-full bg-white/10 px-5 py-2.5 text-xs font-bold uppercase tracking-wider text-white backdrop-blur-sm transition-all duration-300 hover:bg-[#FF8A00] border border-white/10 hover:border-[#FF8A00]">
                                <span>Book Now</span>
